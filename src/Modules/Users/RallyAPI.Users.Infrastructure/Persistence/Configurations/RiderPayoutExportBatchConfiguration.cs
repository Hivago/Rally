...
public sealed class RiderPayoutExportBatchConfiguration : IEntityTypeConfiguration<RiderPayoutExportBatch>
{
    public void Configure(EntityTypeBuilder<RiderPayoutExportBatch> builder)
    {
        builder.ToTable("rider_payout_export_batches", "users");
