...
namespace RallyAPI.Delivery.Infrastructure.Migrations
{
    ...
    [Migration("20260627181442_AddDeliveryRequestXminConcurrencyToken")]
    partial class AddDeliveryRequestXminConcurrencyToken
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RallyAPI.Delivery.Domain.Entities.DeliveryRequest", b =>
                {
                    ...
                    b.Property<decimal?>("ProviderDistanceKm")
                        .HasPrecision(8, 2)
                        .HasColumnType("numeric(8,2)")
                        .HasColumnName("provider_distance_km");

                    b.Property<decimal?>("ProviderLspFee")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasColumnName("provider_lsp_fee");

                    b.Property<string>("ProviderNetworkOrderId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("provider_network_order_id");

                    b.Property<decimal?>("ProviderPlatformFee")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasColumnName("provider_platform_fee");

                    b.Property<decimal?>("ProviderTotalWithTax")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
