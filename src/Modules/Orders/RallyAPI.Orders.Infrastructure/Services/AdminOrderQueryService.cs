...
public sealed class AdminOrderQueryService : IAdminOrderQueryService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new AdminOrderDetail(
            ...
            order.Pricing.PlatformFee.Amount,
            order.Pricing.ServiceGst.Amount,
            order.Pricing.PackagingFee.Amount,
            order.Pricing.ServiceFee.Amount,
            order.Pricing.Tip.Amount,
